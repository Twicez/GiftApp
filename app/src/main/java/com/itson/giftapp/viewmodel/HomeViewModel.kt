package com.itson.giftapp.viewmodel
...
import com.itson.giftapp.data.Image
import com.itson.giftapp.data.ImageDatabase
import com.itson.giftapp.data.ProductDatabase
import com.itson.giftapp.model.BaseClass
import com.itson.giftapp.model.Product
import com.itson.giftapp.service.ProductsAPI
import com.itson.giftapp.utils.CustomSharedPreferences
...
class HomeViewModel : ViewModel() {
    ...
    fun storeInSQLite(context: Context, products: ArrayList<Product>) {
        ...
        viewModelScope.launch {
            ...
            products.forEach {
                val aProduct = com.itson.giftapp.data.Product(it.id,it.title,it.description,it.price,it.discountPercentage,it.rating,it.stock,it.brand,it.category,
                it.thumbnail)
